...
show tables;
select * from employees;
select department_id,max(salary) from employees group by department_id union
select department_id,min(salary) from employees group by department_id;

select first_name,job_title from employees 
left join jobs on employees.job_id=jobs.job_id;

select first_name,salary from employees order by salary limit 1,1;
select first_name,salary from employees where salary between 5000 and 8000;

select distinct count(employee_id)  as ID_COUNT from employees;
select * from employees;
select * from departments;
select  d.manager_id,first_name,avg(salary) from employees 
join departments d on employees.employee_id=d.manager_id
