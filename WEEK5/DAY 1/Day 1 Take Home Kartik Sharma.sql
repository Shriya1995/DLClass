...
select PRODUCT_ID, PRODUCT_DESC, PRODUCT_CLASS_CODE, PRODUCT_PRICE from product where PRODUCT_CLASS_CODE = 2050 or PRODUCT_CLASS_CODE = 2053 or PRODUCT_CLASS_CODE = 2055; 
